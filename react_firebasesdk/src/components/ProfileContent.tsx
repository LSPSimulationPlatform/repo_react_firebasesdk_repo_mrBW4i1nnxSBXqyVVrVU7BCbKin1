...
const ProfileContent = (
    { profileData, fileList, handleUpload, uploading, form, onFinish, user, loading }:
    { profileData:any, fileList:any, handleUpload:any, uploading:any, form:any, onFinish:any, user:any, loading:any }
) => {
  return (
    <Content className="p-6 bg-muted">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card className="mb-6">
          ...
          <q  div className="flex flex-col items-center mb-6">
            <Avatar 
